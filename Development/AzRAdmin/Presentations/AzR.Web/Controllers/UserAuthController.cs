...
namespace AzR.Web.Controllers
{
    ...
    public class UserAuthController : BaseController
    {
        ...
        public UserAuthController(IBaseManager general) : base(general)
        {

        }

        public UserAuthController(MvcApplicationUserManager userManager, MvcApplicationSignInManager signInManager, IBaseManager general) : base(general)
        {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // var callbackUrl = Url.Action("ResetPassword", "UserAuth", new { userId = user.Id, code = code }, protocol: Request.Url.Scheme);		
                // await UserManager.SendEmailAsync(user.Id, "Reset Password", "Please reset your password by clicking <a href=\"" + callbackUrl + "\">here</a>");
                // return RedirectToAction("ForgotPasswordConfirmation", "UserAuth");
            }
        ...
        //
        // GET: /UserAuth/ForgotPasswordConfirmation
        [AllowAnonymous]
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                return RedirectToAction("ResetPasswordConfirmation", "UserAuth");
            }
        ...
        //
        // GET: /UserAuth/ResetPasswordConfirmation
        [AllowAnonymous]
        ...
        public async Task<ActionResult> SendCode(string returnUrl, bool rememberMe)
        {
            ...
            var factorOptions = userFactors.Select(purpose => new DropDownItem { Text = purpose, Value = purpose }).ToList();
            return View(new SendCodeViewModel { Providers = factorOptions, ReturnUrl = returnUrl, RememberMe = rememberMe });
        }

        //
        // POST: /UserAuth/SendCode
        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
