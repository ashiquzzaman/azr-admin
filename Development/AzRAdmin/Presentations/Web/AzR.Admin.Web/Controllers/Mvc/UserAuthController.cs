...
namespace VelocityWorkFlow.Web.Controllers.Mvc
{
    ...
    public class UserAuthController : BaseController
    {
        ...
        {
            if (!BaseHepler.IsActive(model.UserName))
            {
        ...
        public ActionResult ExternalLogin(string provider, string returnUrl)
        {
            ...
            return new ChallengeResult(provider, Url.Action("ExternalLoginCallback", "UserAuth", new { ReturnUrl = returnUrl }));
        }
        ...
        //
        // GET: /UserAuth/ExternalLoginCallback
        [AllowAnonymous]
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            {
                case SignInStatus.Success:
                    BaseHepler.SetCookie(loginInfo.Email);
                    return RedirectToLocal(returnUrl);
                case SignInStatus.LockedOut:
                    return View("Lockout");
                case SignInStatus.RequiresVerification:
        ...
        //
        // POST: /UserAuth/ExternalLoginConfirmation
        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
